    ...
    <div className={styles.contactPage}>
      <section className={styles.heroSection}>
        <div className={styles.heroContainer}>
          <h1 className={styles.heroTitle}>{contactContent.heroTitle}</h1>
          <div className={styles.contentWrapper}>
            <div className={styles.leftContent}>
              <p className={styles.heroSubtitle}>{contactContent.heroSubtitle}</p>
              <div className={styles.profileCard}>
                <img
                  src={contactContent.profile.imageSrc}
                  alt={contactContent.profile.imageAlt}
                  className={styles.profileImage}
                />
                <div className={styles.profileInfo}>
                  <h3 className={styles.profileName}>{contactContent.profile.name}</h3>
                  <p className={styles.profileRole}>{contactContent.profile.role}</p>
                </div>
              </div>
            </div>
            <div className={styles.rightContent}>
              <div className={styles.emailSection}>
                <div>
                  <h2 className={styles.emailTitle}>{contactContent.email.display}</h2>
                  <a href={contactContent.email.href} className={styles.link}>
                    ...
                    <span className={styles.linkText}>{contactContent.email.ctaLabel}</span>
                  </a>
                </div>
              </div>
              ...
              <div className={styles.linksSection}>
                ...
                <button type="submit" className={styles.submitLink} onClick={handleSubmit}>
                  ...
                  <span>{contactContent.form.submitLabel}</span>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className={styles.faqGrid}>
            <div className={styles.faqLeft}>
              <div className={styles.faqHeader}>
                <h2 className={styles.faqTitle}>{contactContent.faqHeader.title}</h2>
                <p className={styles.faqSubtitle}>{contactContent.faqHeader.subtitle}</p>
              </div>
              <button className={styles.faqAskBtn}>
                ...
                <span>{contactContent.faqHeader.askLabel}</span>
              </button>
            </div>
            <div className={styles.faqRight}>
              <div className={styles.faqList}>
                {contactContent.faq.map((faq: { question: React.ReactNode; answer: React.ReactNode }, index: number) => (
